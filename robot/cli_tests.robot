*** Settings ***
Documentation    CLI integration tests for lynx-industrials
Library          Process
Library          OperatingSystem

*** Variables ***
${PYTHON}        python3
${MODULE}        lynx_industrials
...
Given The Application Is Available
    Run App    --version
    Should Contain    ${OUTPUT}    lynx-industrials
...
Show About
    ...
    When I Run About
    Then The Exit Code Should Be 0
    Then The Output Should Contain "Lynx Industrials Analysis"
...
Explain An Industrials-Specific Metric
    [Documentation]    GIVEN the app WHEN I explain operating_ratio THEN it shows the operating-ratio explanation
    Given The Application Is Available
    When I Explain Metric "operating_ratio"
    Then The Exit Code Should Be 0
    Then The Output Should Contain "Operating Ratio"
