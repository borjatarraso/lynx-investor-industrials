"""Tkinter graphical user interface for Lynx Industrials Analysis."""
...
class SplashScreen:
    ...
    def __init__(self, root: tk.Tk, on_done: callable) -> None:
        ...
        self.subtitle = tk.Label(
            center, text="Industrials Analysis", font=FONT_SPLASH_SUB,
            bg=BG, fg=ACCENT,
        )
        ...
        self.tagline = tk.Label(
            center, text="Aerospace, Defense, Transportation & Machinery", font=FONT_SMALL,
            bg=BG, fg=FG_DIM,
        )
        self.tagline.pack(pady=(0, 30))

        # Version
        from lynx_industrials import __version__, __year__, __author__, SUITE_LABEL
...
class LynxIndustrialsGUI:
    """Tkinter GUI application for Lynx Industrials Analysis."""
    ...
    def __init__(self, cli_args) -> None:
        ...
        self.root = tk.Tk()
        self.root.title("Lynx Industrials Analysis")
    ...
    def _after_splash(self) -> None:
        ...
        from lynx_industrials.tui.themes import HOUSE_THEMES as _HOUSE_THEMES
        ...
        try:
            ...
            pass
        self._theme_cycler = ThemeCycler(self.root, start="industrials-dark")
    ...
    def _build_toolbar(self) -> None:
        ...
        tk.Label(
            brand, text="Lynx Industrials", font=(_FAMILY, 14, "bold"),
    ...
    def _show_themes_menu(self) -> None:
        ...
        sector_family = ["industrials-dark", "industrials-light"]
    ...
    def _show_controls(self) -> None:
        ...
        self._show_info_popup(
            ...
            "lynx-industrials -- Graphical Interface",
            sections,
        )

    def _on_about(self) -> None:
        from lynx_industrials import get_about_text
        about = get_about_text()

        win = tk.Toplevel(self.root)
        win.title("About lynx-industrials")
        win.configure(bg=BG)
    ...
    def _ee_shake(self) -> None:
        from lynx_industrials.easter import tk_fireworks
        tk_fireworks(self.root)

    def _ee_rainbow(self) -> None:
        from lynx_industrials.easter import tk_rainbow_title
        tk_rainbow_title(self.root)

    def _ee_fortune(self) -> None:
        from lynx_industrials.easter import FORTUNE_QUOTES
        import random
    ...
    def _run_analysis(self, identifier: str) -> None:
        try:
            ...
            from lynx_industrials.core.storage import is_testing
    ...
    def _render_valuation(self, r: AnalysisReport) -> None:
        ...
        from lynx_industrials.display import (
    ...
    def _render_business_quality(self, r: AnalysisReport) -> None:
        ...
        card = CollapsibleCard(
            ...
            icon=ICON_INDUSTRIAL, accent=YELLOW, expanded=False,
        ...
        rows: list[tuple[str, str, str]] = [
            ...
            ("Backlog / Margin Strength", _s(m.backlog_strength), "backlog_strength"),
            ...
            ("Aftermarket / Services Mix", _s(m.aftermarket_mix_quality), "aftermarket_mix_quality"),
            ("Cyclical Sensitivity", _s(m.cyclical_sensitivity), "cyclical_sensitivity"),
            ("End-Market Exposure", _s(m.end_market_exposure), "end_market_exposure"),
    ...
    def _render_screening(self, r: AnalysisReport) -> None:
        """Render the 10-point industrials screening checklist."""
        ...
        card = CollapsibleCard(
            self.scroll_frame, "Industrials Screening Checklist",
    ...
    def _download_filing_gui(self, filing) -> None:
        ...
        def _do():
            from lynx_industrials.core.reports import download_filing
            try:
    ...
    def _show_metric_info(self, key: str) -> None:
        from lynx_industrials.metrics.explanations import get_explanation
    ...
    def _show_section_info(self, section_key: str) -> None:
        from lynx_industrials.metrics.explanations import get_section_explanation
    ...
    def _show_conclusion_info(self, category: str = "overall") -> None:
        from lynx_industrials.metrics.explanations import get_conclusion_explanation
...
def run_gui(args) -> None:
    ...
    app = LynxIndustrialsGUI(cli_args=args)
    app.run()
