...
""")
    ...
    if report.valuation:
        ...
        parts.append(_metric_table([
            ...
            ("EV per Backlog", _fmt_num(v.ev_per_backlog, 2)),
            ("EV per Employee", _fmt_money(v.ev_per_employee)),
    ...
    if c.screening_checklist:
        parts.append("<h2>Industrials Screening Checklist</h2>")
    ...
    parts.append(f"""
<div class="footer">
  Lynx Industrials Analysis &mdash; Lince Investor Suite<br>
