"""Textual UI for Lynx Industrials Analysis."""
...
class LynxIndustrialsApp(PagingAppMixin, App):
    TITLE = "Lynx Industrials Analysis"
    SUB_TITLE = "Industrials Fundamental Analysis"
    CSS = """
    #search-dialog {
        width: 60;
        height: auto;
    ...
    def on_mount(self) -> None:
        from lynx_industrials.tui.themes import register_all_themes, THEME_NAMES
        try:
            register_all_themes(self)
            self.theme = THEME_NAMES[0]  # industrials-dark
        except Exception:
    ...
    def compose(self) -> ComposeResult:
        yield Header()
        yield Static(
            "[bold blue]  lynx-industrials  [/]\n\n"
            "[bold]Industrials Analysis Tool[/]\n"
    ...
    def action_cycle_theme(self) -> None:
        from lynx_industrials.tui.themes import THEME_NAMES
    ...
    def action__ee_lynx(self) -> None:
        from lynx_industrials.easter import LYNX_ASCII, WOLF_ASCII, BULL_ASCII
        import random
