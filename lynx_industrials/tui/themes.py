"""Custom Textual themes for the lynx-industrials TUI application.
...
THEME_NAMES: List[str] = (
    ["industrials-dark", "industrials-light"] + SUITE_THEME_NAMES + ["textual-dark", "textual-light"]
)
